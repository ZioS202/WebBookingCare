  ...
  Object.entries(data).forEach(entry => {
    ...
    const html = `
      <table>
        <tr>
          <td>
            <a href="/doctor/doctorDetail/${key}">
...
searchForm.onsubmit = async function (e) {
  ...
  const specialists = await search_doctor(csrfmiddlewaretoken, query);

  //Refresh list specialist
  divContent.innerHTML = `<h3 style="font-weight:bold">Thông tin các bác sĩ nổi bật:</h3>`;
